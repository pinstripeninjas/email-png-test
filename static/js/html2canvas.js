...
(function (global, factory) {
  ...
  ***************************************************************************** */
	...
	var isEndingTokenFor = function (token, type) {
		...
		return (
			type === TokenType.LEFT_PARENTHESIS_TOKEN && token.type === TokenType.RIGHT_PARENTHESIS_TOKEN
		);
	};
	...
	var hsl = function (args) {
		...
		var hue = tokens[0],
			...
			alpha = tokens[3];
		var h =
			(hue.type === TokenType.NUMBER_TOKEN ? deg(hue.number) : angle.parse(hue)) / (Math.PI * 2);
	...
	(function (PropertyDescriptorParsingType) {
		...
		PropertyDescriptorParsingType[(PropertyDescriptorParsingType["IDENT_VALUE"] = 2)] =
			"IDENT_VALUE";
		PropertyDescriptorParsingType[(PropertyDescriptorParsingType["TYPE_VALUE"] = 3)] = "TYPE_VALUE";
		PropertyDescriptorParsingType[(PropertyDescriptorParsingType["TOKEN_VALUE"] = 4)] =
			"TOKEN_VALUE";
	...
	var createCounterStyleFromSymbols = function (value, symbols, suffix) {
		...
		return (
			createCounterStyleWithSymbolResolver(Math.abs(value), codePointRangeLength, false, function (
				codePoint
			) {
